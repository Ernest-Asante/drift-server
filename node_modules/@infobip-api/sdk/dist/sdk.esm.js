...
(function (Validator) {
  ...
  function _boolean(x, name) {
    if (typeof x !== 'boolean') {
      throw new Error(name + " must be a boolean.");
    }
    return true;
  }
  Validator["boolean"] = _boolean;
...
var InfobipAuth = function InfobipAuth(_ref) {
  var baseUrl = _ref.baseUrl,
    ...
    authType = _ref$authType === void 0 ? AuthType.ApiKey : _ref$authType,
  ...
  switch (authType) {
    ...
    default:
      this.authorization = '';
      throw new Error("Invalid authentication type: " + authType + ". The only supported types are: " + AuthType.ApiKey + ", " + AuthType.Basic + ", " + AuthType.IBSSO + ", " + AuthType.OAuth);
  }
};
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              http = new Http(this.credentials.baseUrl, AuthType.IBSSO + " " + ibssoToken);
              _context2.next = 4;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              http = new Http(this.credentials.baseUrl);
              _context3.next = 6;
              return http.post(endpoints$2.oauth2 + "?" + new URLSearchParams$1({
  ...
  if (typeof data === 'object') {
    Object.keys(data).forEach(function (key) {
      if (key === 'attachment' || key === 'inlineImage') {
        data[key].forEach(function (attachedObject) {
          formData.append(parentKey ? parentKey + "['" + key + "']" : key, attachedObject.data, attachedObject.name);
        });
      } else {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              email.to.forEach(function (to, index) {
              ...
              if (email.cc) {
                ...
                email.cc.forEach(function (cc, index) {
              ...
              if (email.bcc) {
                ...
                email.bcc.forEach(function (bcc, index) {
            ...
            case 12:
              ...
              if (email.attachment) {
                ...
                email.attachment.forEach(function (attachmentObject) {
                  Validator.required(attachmentObject.data, 'email.attachment[].data');
                  Validator.requiredString(attachmentObject.name, 'email.attachment[].name');
                });
              }
              if (email.inlineImage) {
                Validator.array(email.inlineImage, 'email.inlineImage');
                email.inlineImage.forEach(function (inlineImage) {
                  Validator.required(inlineImage.data, 'email.inlineImage[].data');
                  Validator.requiredString(inlineImage.name, 'email.inlineImage[].name');
                });
              }
              ...
              if (email.defaultPlaceholders) {
                Validator.string(email.defaultPlaceholders, 'email.defaultPlaceholders');
              }
              ...
              if (email.landingPagePlaceholders) {
                Validator.string(email.landingPagePlaceholders, 'email.landingPagePlaceholders');
              }
              if (email.landingPageId) {
                Validator.string(email.landingPageId, 'email.landingPageId');
              }
              if (email.templateLanguageVersion) {
                Validator.string(email.templateLanguageVersion, 'email.templateLanguageVersion');
              }
...
var TwoFA = /*#__PURE__*/function () {
  function TwoFA(credentials) {
    this.http = new Http(credentials.baseUrl, credentials.authorization);
    this.username = credentials.username;
    this.password = credentials.password;
  }
   ...
   * @return { AxiosResponse<any, any> } response - Return Axios Response
   */
  var _proto = TwoFA.prototype;
  _proto.getApplications =
  /*#__PURE__*/
  function () {
    var _getApplications = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var response;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return this.http.get(TwoFAEndpoints.uri);
            case 3:
              response = _context.sent;
              return _context.abrupt("return", response);
            case 7:
   ...
   */
  ;
  _proto.createApplication =
  /*#__PURE__*/
  function () {
    var _createApplication = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(reqBody) {
      var response;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 4;
              return this.http.post(TwoFAEndpoints.uri, reqBody);
            case 4:
              response = _context2.sent;
              return _context2.abrupt("return", response);
            case 8:
   ...
   */
  ;
  _proto.getApplication =
  /*#__PURE__*/
  function () {
    var _getApplication = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(appId) {
      var response;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 4;
              return this.http.get(TwoFAEndpoints.uri + ("/" + appId));
            case 4:
              response = _context3.sent;
              return _context3.abrupt("return", response);
            case 8:
   ...
   */
  ;
  _proto.updateApplication =
  /*#__PURE__*/
  function () {
    var _updateApplication = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(appId, reqBody) {
      var response;
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              Validator.requiredString(reqBody.name, 'name');
              _context4.next = 5;
              return this.http.put(TwoFAEndpoints.uri + ("/" + appId), reqBody);
            case 5:
              response = _context4.sent;
              return _context4.abrupt("return", response);
            case 9:
    ...
    function updateApplication(_x3, _x4) {
      return _updateApplication.apply(this, arguments);
    }
   ...
   */
  ;
  _proto.getMessageTemplates =
  /*#__PURE__*/
  function () {
    var _getMessageTemplates = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(appId) {
      var response;
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              Validator.requiredString(appId, 'appId');
              _context5.next = 4;
              return this.http.get(TwoFAEndpoints.uri + ("/" + appId + "/messages"));
            case 4:
              response = _context5.sent;
              return _context5.abrupt("return", response);
            case 8:
    ...
    function getMessageTemplates(_x5) {
      return _getMessageTemplates.apply(this, arguments);
    }
   ...
   */
  ;
  _proto.createMessageTemplate =
  /*#__PURE__*/
  function () {
    var _createMessageTemplate = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(appId, reqBody) {
      var response;
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              if (reqBody.regional && reqBody.regional.indiaDlt) {
                Validator.requiredString(reqBody.regional.indiaDlt.principalEntityId, 'reqBody.regional.indiaDlt.principalEntityId');
              }
              _context6.next = 7;
              return this.http.post(TwoFAEndpoints.uri + ("/" + appId + "/messages"), reqBody);
            case 7:
              response = _context6.sent;
              return _context6.abrupt("return", response);
            case 11:
    ...
    function createMessageTemplate(_x6, _x7) {
      return _createMessageTemplate.apply(this, arguments);
    }
   ...
   */
  ;
  _proto.getMessageTemplate =
  /*#__PURE__*/
  function () {
    var _getMessageTemplate = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(appId, messageId) {
      var response;
      return _regeneratorRuntime().wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              ...
              _context7.next = 5;
              return this.http.get(TwoFAEndpoints.uri + ("/" + appId + "/messages/" + messageId));
            case 5:
              response = _context7.sent;
              return _context7.abrupt("return", response);
            case 9:
    ...
    function getMessageTemplate(_x8, _x9) {
      return _getMessageTemplate.apply(this, arguments);
    }
   ...
   */
  ;
  _proto.updateMessageTemplate =
  /*#__PURE__*/
  function () {
    var _updateMessageTemplate = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(appId, messageId, reqBody) {
      var response;
      return _regeneratorRuntime().wrap(function _callee8$(_context8) {
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              ...
              _context8.next = 6;
              return this.http.put(TwoFAEndpoints.uri + ("/" + appId + "/messages/" + messageId), reqBody);
            case 6:
              response = _context8.sent;
              return _context8.abrupt("return", response);
            case 10:
    ...
    function updateMessageTemplate(_x10, _x11, _x12) {
      return _updateMessageTemplate.apply(this, arguments);
    }
   ...
   */
  ;
  _proto.sendPINCodeSMS =
  /*#__PURE__*/
  function () {
    var _sendPINCodeSMS = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(reqBody, ncNeededQuery) {
      var ncNeeded, query, queryString, response;
      return _regeneratorRuntime().wrap(function _callee9$(_context9) {
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              ...
              _context9.next = 10;
              return this.http.post(pin2FAEndpoints.uri + ("/?" + queryString), reqBody);
            case 10:
              response = _context9.sent;
              return _context9.abrupt("return", response);
            case 14:
    ...
    function sendPINCodeSMS(_x13, _x14) {
      return _sendPINCodeSMS.apply(this, arguments);
    }
    return sendPINCodeSMS;
  }()
  /**
   ...
   */
  ;
  _proto.resendPINCodeSMS =
  /*#__PURE__*/
  function () {
    var _resendPINCodeSMS = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(pinId, reqBody) {
      var response;
      return _regeneratorRuntime().wrap(function _callee10$(_context10) {
        while (1) {
          switch (_context10.prev = _context10.next) {
            case 0:
              ...
              _context10.next = 5;
              return this.http.post(pin2FAEndpoints.uri + ("/" + pinId + "/resend"), reqBody);
            case 5:
              response = _context10.sent;
              return _context10.abrupt("return", response);
            case 9:
    ...
    function resendPINCodeSMS(_x15, _x16) {
      return _resendPINCodeSMS.apply(this, arguments);
    }
    return resendPINCodeSMS;
  }()
  /**
   ...
   */
  ;
  _proto.sendPINCodeVoice =
  /*#__PURE__*/
  function () {
    var _sendPINCodeVoice = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11(reqBody) {
      var response;
        ...
        while (1) {
          switch (_context11.prev = _context11.next) {
            case 0:
              ...
              Validator.requiredString(reqBody.to, 'to');
              _context11.next = 6;
              return this.http.post(pin2FAEndpoints.uri + '/voice', reqBody);
            case 6:
    ...
    function sendPINCodeVoice(_x17) {
      return _sendPINCodeVoice.apply(this, arguments);
    }
    return sendPINCodeVoice;
  }()
  /**
   ...
   */
  ;
  _proto.resendPINCodeVoice =
  /*#__PURE__*/
  function () {
    var _resendPINCodeVoice = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12(pinId, reqBody) {
      var response;
        ...
        while (1) {
          switch (_context12.prev = _context12.next) {
            case 0:
              ...
              Validator.requiredString(pinId, 'pinId');
              _context12.next = 5;
              return this.http.post(pin2FAEndpoints.uri + ("/" + pinId + "/resend/voice"), reqBody);
            case 5:
    ...
    function resendPINCodeVoice(_x18, _x19) {
      return _resendPINCodeVoice.apply(this, arguments);
    }
    return resendPINCodeVoice;
  }()
  /**
   ...
   */
  ;
  _proto.verifyPhoneNumber =
  /*#__PURE__*/
  function () {
    var _verifyPhoneNumber = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee13(pinId, reqBody) {
      var response;
        ...
        while (1) {
          switch (_context13.prev = _context13.next) {
            case 0:
              ...
              _context13.next = 5;
              return this.http.post(pin2FAEndpoints.uri + ("/" + pinId + "/verify"), reqBody);
            case 5:
    ...
    function verifyPhoneNumber(_x20, _x21) {
   ...
   */
  ;
  _proto.getVerificationStatus =
  /*#__PURE__*/
  function () {
    var _getVerificationStatus = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14(appId, queryParameters) {
      var query, queryString, response;
        ...
        while (1) {
          switch (_context14.prev = _context14.next) {
            case 0:
              ...
              query = new URLSearchParams(queryParameters);
              queryString = query.toString();
              _context14.next = 7;
              return this.http.get(TwoFAEndpoints.uri + ("/" + appId + "/verifications/?" + queryString));
            case 7:
    ...
    function getVerificationStatus(_x22, _x23) {
      return _getVerificationStatus.apply(this, arguments);
    }
...
export { AuthType, EmailStatus, Infobip };
